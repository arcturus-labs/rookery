...
- The YAML needs to mention the environment they are associated with by id (e.g. loc:homedepot.com/store-4321) because the environment state changes and notifications will use this id.
